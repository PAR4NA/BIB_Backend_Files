...
class CfgSettings
{
	...
	class VehicleSpawn
	{
		...
		*/
		damageChance = 50; // % chance for a vehicle HITPOINT to be damaged
		maximumDamage = 0.9;
		...
		ground[] = 
		{
			...
			"Skyline_Bus_01_F",
			"Skyline_Bus_01_F",
			"Skyline_Mercedes_300_SEL_01_F",
			"Skyline_Mercedes_300_SEL_01_F",
			"Skyline_Mercedes_300_SEL_01_F",
			"Skyline_Mercedes_C63_01_F",
			"Skyline_Mercedes_C63_01_F",
			"Skyline_Mercedes_C63_01_F",
			"Mrshounka_a3_308_p",
			"Mrshounka_a3_308_p",
	...
	class Weather
	{
		...
		*/
		...
		keyframes[] = {/*"Sunny", "Cloudy", "Thunderstorm",*/ "Hurican"}; 
